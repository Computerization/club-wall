...
export const clubs: Club[] = [
  ...
  { id: "40", name: "信息化社 Computerization", category: "Service", shortDesc: "网站好玩吗 我们做的", tags: ["技术", "运维", "服务", "协作"], description: "用技术支撑校园里的每一次活动与每一块屏幕。", image: "/covers/b2.jpg", posters: ["/posters/f21-1.jpg"], qrcodes: ["/qrcodes/f21-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  // Life
