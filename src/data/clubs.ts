...
export const clubs: Club[] = [
  ...
  { id: "70", name: "食品研究社", category: "Academic", shortDesc: "Food Science", tags: ["美食", "实验", "营养", "分享"], description: "从厨房到实验室，探究食物背后的科学与乐趣。", image: "/covers/b13.jpg", posters: ["/posters/f67-1.jpg"], qrcodes: ["/qrcodes/f67-1.png"], posterHtml: "", contact: "" },
  ...
  { id: "74", name: "沪语弄堂", category: "ClubsToBeEstablished", shortDesc: "Shanghainese", tags: ["语言", "文化", "上海", "传承"], description: "本社团聚焦上海语言与文化，旨在向内激发兴趣、深入理解，向外推广沪语文化，为拯救沪语出力。", image: "/covers/b8.jpg", posters: ["/posters/b8-1.jpg"], qrcodes: ["/qrcodes/b8-1.png"], posterHtml: "", contact: "" },
];
