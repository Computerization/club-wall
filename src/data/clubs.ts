...
export const clubs: Club[] = [
  ...
  { id: "3", name: "Disko Elysium 飞盘社", category: "Sports", shortDesc: "Frisbee", tags: ["竞技运动", "合作团结", "便捷实惠"], description: "一群玩飞盘的朋友聚在一块，以纯粹的热爱践行体育精神", image: "/covers/b12.jpg", posters: ["/posters/f66-1.jpg"], qrcodes: ["/qrcodes/f66-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  ...
  { id: "6", name: "世外足球社", category: "Sports", shortDesc: "Football", tags: ["热血", "团队", "拼搏", "荣耀"], description: "因足球相聚，为胜利拼搏", image: "/covers/f24.jpg", posters: ["/posters/f24-1.jpg"], qrcodes: ["/qrcodes/f24-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  ...
  { id: "15", name: "Kaleido 万华境戏剧社", category: "Arts", shortDesc: "Theatre", tags: ["艺术", "交流", "思辨"], description: "在Kaleido专业化的戏剧制作过程中，你可以接触台前和台后的多种工作。来Kaleido，与我们一起踏入戏剧艺术的万华境。", image: "/covers/f41.jpg", posters: ["/posters/f41-1.jpg"], qrcodes: ["/qrcodes/kaleido.jpg"], posterHtml: "", contact: "", rating: "five-star" },
  { id: "16", name: "Museholic 翻唱社", category: "Arts", shortDesc: "Cover Songs", tags: ["热爱", "多元", "共鸣"], description: "以翻唱抒心意，凭歌声遇知音，奔赴音乐热爱。", image: "/covers/f11.jpg", posters: ["/posters/f11-1.jpg"], qrcodes: ["/qrcodes/f11-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  { id: "17", name: "OAO 摄影社", category: "Arts", shortDesc: "Photography", tags: ["专业制式工作流团队", "校内外多项活动官摄", "照片视频双团队"], description: "让我们一起用镜头记录下生活中的点点滴滴吧！", image: "/covers/f12.jpg", posters: ["/posters/f12-1.jpg"], qrcodes: ["/qrcodes/f12-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  ...
  { id: "23", name: "OAU 世外舞社", category: "Arts", shortDesc: "Dance", tags: ["舞蹈", "热爱"], description: "以热爱赴舞蹈之约 希望所有热爱现代舞 爵士舞 hiphop kpop等舞种的大家找到一个自由交流的平台", image: "https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=400&h=300&fit=crop", posters: ["/posters/f13-1.jpg"], qrcodes: ["/qrcodes/f13-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  ...
  { id: "27", name: "音乐剧社", category: "Arts", shortDesc: "Musical", tags: ["歌唱", "表演", "舞台", "戏剧"], description: "用歌声与表演，把一个个故事搬上舞台。", image: "/covers/story-teller.jpg", posters: ["/posters/story-teller.jpg"], qrcodes: ["/qrcodes/story-teller.jpg"], posterHtml: "", contact: "" },
  { id: "76", name: "RSO管弦乐团", category: "Arts", shortDesc: "Orchestra", tags: ["古典乐", "合奏", "舞台"], description: "用琴弦与管乐，奏响校园最动人的旋律。", image: "/covers/f76.jpg", posters: ["/posters/b76-1.jpg"], qrcodes: ["/qrcodes/b76-1.jpg"], posterHtml: "", contact: "微信：pamelajiangzixuan", rating: "five-star" },
  // Service
  { id: "28", name: "Prologue 动物保护社", category: "Service", shortDesc: "Animal Welfare", tags: ["温暖", "团结", "有爱", "抽象"], description: "看见动物，了解动物，保护动物", image: "/covers/f56.jpg", posters: [], qrcodes: ["/qrcodes/f56-1.png"], posterHtml: "/poster-html/prologue.html", contact: "", rating: "outstanding" },
  ...
  { id: "33", name: "拓科传媒 Techomedia", category: "Service", shortDesc: "Tech & Media", tags: ["科技", "传媒"], description: "作为华东首家独立学生创客社团，TechMedia带你追踪前沿科技、玩转社交媒体，邂逅科技与传媒的独特跨界魅力。", image: "/covers/f42.jpg", posters: ["/posters/techo.png"], qrcodes: ["/qrcodes/techo.jpg"], posterHtml: "", contact: "", rating: "outstanding" },
  { id: "34", name: "根与芽社 Roots & Shoots", category: "Service", shortDesc: "Environment", tags: ["环境", "动态发展", "社会", "互动"], description: "根与芽以实际行动探索、建立、增进社会与自然之间的联系。", image: "/covers/f15.jpg", posters: ["/posters/f15-1.jpg"], qrcodes: ["/qrcodes/f15-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  ...
  { id: "37", name: "Voice", category: "Service", shortDesc: "Social Voice", tags: ["观测", "共鸣", "连接", "发声"], description: "请带上好奇心，我们带你一起去到真实的社会里，做一场不设限的冒险，和你未曾谋面的他们交个朋友～", image: "/covers/f17.jpg", posters: ["/posters/f17-1.jpg"], qrcodes: ["/qrcodes/f17-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  { id: "38", name: "无障碍社 BonVista", category: "Service", shortDesc: "Accessibility", tags: ["物理无障碍", "社会服务", "艺术疗愈", "弱势群体关怀"], description: "我们是一群传播无障碍理念的使者", image: "/covers/f44.jpg", posters: ["/posters/f44-1.jpg"], qrcodes: ["/qrcodes/f44-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  ...
  { id: "40", name: "信息化社 Computerization", category: "Service", shortDesc: "网站好玩吗 我们做的", tags: ["技术", "运维", "服务", "协作"], description: "用技术支撑校园里的每一次活动与每一块屏幕。", image: "/covers/b2.jpg", posters: ["/posters/computerization.png"], qrcodes: ["/qrcodes/computerization.png"], posterHtml: "", contact: "", rating: "five-star" },
  // Life
  ...
  { id: "44", name: "世外汽车社 Power Galaxy", category: "Academic", shortDesc: "Automobile", tags: ["赛车", "热爱", "速度", "极限"], description: "这里汇聚了一群热爱汽车的同学们，we learn together, we play together!", image: "/covers/f50.jpg", posters: [], qrcodes: ["/qrcodes/f50-1.png"], posterHtml: "/poster-html/power-galaxy.html", contact: "", rating: "outstanding" },
  ...
  { id: "46", name: "光度心理社 Luminosity", category: "Academic", shortDesc: "Psychology", tags: ["自我探索", "艺术手工", "学术培养"], description: "心理学是一个非常宽泛有趣的学科，因此我们可以在社团的时候做任何事！期待你们加入这个温暖的大家庭…", image: "/covers/f8.jpg", posters: ["/posters/f8-1.jpg"], qrcodes: ["/qrcodes/f8-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  ...
  { id: "52", name: "嘎嘣脆语言文学社 Crunchy Zoo", category: "Academic", shortDesc: "Linguistics & Literature", tags: ["文学", "写作", "语言学"], description: "以语言为媒，与文字、山海、灵魂温柔相逢", image: "/covers/f59.jpg", posters: ["/posters/f59-1.jpg"], qrcodes: ["/qrcodes/f59-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  { id: "53", name: "Mock Trial 模拟法庭社", category: "Academic", shortDesc: "Moot Court", tags: ["法学", "思辨", "演绎"], description: "同学，想体验《逆转裁判》的快乐吗？ 如果你喜欢辩论、擅长临场应变，或者想体验当庭对峙的刺激感，模拟法庭社就是你的选择！", image: "/covers/f47.jpg", posters: ["/posters/f47-1.jpg"], qrcodes: ["/qrcodes/f47-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  ...
  { id: "56", name: "脑神经科学社 Brainbee", category: "Academic", shortDesc: "Neuroscience", tags: ["前沿", "神秘"], description: "每一个大脑都有自己的语言，等你来解！", image: "/covers/f57.jpg", posters: ["/posters/f57-1.jpg"], qrcodes: ["/qrcodes/f57-1.png"], posterHtml: "", contact: "", rating: "five-star" },
  ...
  { id: "59", name: "化学社 ChemiClub", category: "Academic", shortDesc: "Chemistry", tags: ["学术", "多元", "链接"], description: "硬核讲座&整活实验，这就是化学社！", image: "/covers/f30.jpg", posters: ["/posters/f30-1.jpg"], qrcodes: ["/qrcodes/f30-1.png"], posterHtml: "", contact: "", rating: "outstanding" },
  ...
  { id: "62", name: "法语文化社 Le Nord", category: "Academic", shortDesc: "French Culture", tags: ["远行", "创作", "分享", "优雅"], description: "法语文化社以法语语种开展影视鉴赏、诗歌研讨、杂志编创与文化课。", image: "/covers/f51.jpg", posters: ["/posters/f51-1.jpg"], qrcodes: [], posterHtml: "", contact: "", rating: "outstanding" },
  { id: "63", name: "物理社 Physics Society", category: "Academic", shortDesc: "Physics", tags: ["趣味物理", "创新实验", "跨社联动", "科学探索"], description: "以实验激发兴趣让物理走进校园点亮科学思维", image: "/covers/b9.jpg", posters: [], qrcodes: ["/qrcodes/f53-1.png"], posterHtml: "/poster-html/physics.html", contact: "", rating: "five-star" },
  ...
  { id: "66", name: "极客工坊 E3 Lab", category: "Academic", shortDesc: "Engineering", tags: ["Engineering", "Empathy", "Empower"], description: "全校唯一一个工程类社团", image: "/covers/b7.jpg", posters: [], qrcodes: ["/qrcodes/f46-1.png"], posterHtml: "/poster-html/e3-lab.html", contact: "", rating: "five-star" },
  ...
  { id: "69", name: "环境科学社", category: "Academic", shortDesc: "Environment", tags: ["环境", "科学", "可持续", "调研"], description: "关注身边的环境议题，用科学的方式探索可持续未来。", image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=400&h=300&fit=crop", posters: ["/posters/env-sci.jpg"], qrcodes: ["/qrcodes/env-sci.jpg"], posterHtml: "", contact: "" },
