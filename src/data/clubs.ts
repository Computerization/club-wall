...
export const clubs: Club[] = [
  ...
  { id: "3", name: "Disko Elysium 飞盘社", category: "Sports", shortDesc: "Frisbee", tags: ["竞技运动", "合作团结", "便捷实惠"], description: "一群玩飞盘的朋友聚在一块，以纯粹的热爱践行体育精神", image: "/covers/b11.jpg", posters: ["/posters/f66-1.jpg"], qrcodes: ["/qrcodes/f66-1.png"], posterHtml: "", contact: "" },
  ...
  { id: "12", name: "乒乓社", category: "Sports", shortDesc: "Table Tennis", tags: ["国球", "速度", "旋转", "友谊"], description: "小小银球乒乓往来，挥拍之间皆是热爱。", image: "/covers/b1.jpg", posters: ["/posters/f29-1.jpg"], qrcodes: ["/qrcodes/f29-1.png"], posterHtml: "", contact: "" },
  { id: "13", name: "网球社", category: "Sports", shortDesc: "Tennis", tags: ["热爱", "拼搏", "成长", "超越"], description: "在网球场挥洒汗水，用热爱成就更好的自己。", image: "/covers/b9.jpg", posters: ["/posters/b9-1.jpg"], qrcodes: ["/qrcodes/b9-1.png"], posterHtml: "", contact: "" },
  // Arts
  ...
  { id: "24", name: "Modi 3D建模社", category: "Arts", shortDesc: "3D Modeling", tags: ["创新", "艺术", "技术"], description: "我们是一个计算机技术与艺术相融的创新社团，主要学习如何用Blender这个软件把脑海中的3D建构建模出来，并进行渲染和动画，运用领域包括动画视频，游戏道具建模，产品模型。", image: "/covers/f10.jpg", posters: [], qrcodes: ["/qrcodes/f10-1.png"], posterHtml: "/poster-html/modi-3d.html", contact: "" },
  ...
  { id: "37", name: "Voice", category: "Service", shortDesc: "Social Voice", tags: ["观测", "共鸣", "连接", "发声"], description: "我们倾听角落里的低语，与社会边缘的灵魂共鸣，发声于时代的聚光灯外。", image: "/covers/f17.jpg", posters: ["/posters/f17-1.jpg"], qrcodes: ["/qrcodes/f17-1.png"], posterHtml: "", contact: "" },
  ...
  { id: "42", name: "汉文化社 Han Culture", category: "Life", shortDesc: "Chinese Culture", tags: ["中国文化", "社会", "传承", "古今碰撞"], description: "我们是汉文化社，包含着中国上下五千年的衣食住行，回溯历史，重看今世", image: "/covers/f49.jpg", posters: [], qrcodes: ["/qrcodes/f49-1.png"], posterHtml: "/poster-html/han-culture.html", contact: "" },
  // Academic
  ...
  { id: "50", name: "韩文化社 Korean Culture", category: "Academic", shortDesc: "Korean Culture", tags: ["多元", "热血", "kpop", "文化"], description: "始于韩流，陷于文化，忠于热爱", image: "/covers/b10.jpg", posters: ["/posters/f64-1.jpg"], qrcodes: ["/qrcodes/f64-1.png"], posterHtml: "", contact: "" },
  ...
  { id: "55", name: "拾遗文化社 C-ker", category: "Academic", shortDesc: "Heritage & Crafts", tags: ["非遗", "部落", "人文", "手作"], description: "仰望星空，探寻远古，近看非遗，传承守望，这里是C-ker", image: "/covers/f43.jpg", posters: ["/posters/f43-1.jpg"], qrcodes: ["/qrcodes/f43-1.png"], posterHtml: "", contact: "" },
  ...
  { id: "63", name: "物理社 Physics Society", category: "Academic", shortDesc: "Physics", tags: ["趣味物理", "创新实验", "跨社联动", "科学探索"], description: "以实验激发兴趣让物理走进校园点亮科学思维", image: "/covers/b8.jpg", posters: [], qrcodes: ["/qrcodes/f53-1.png"], posterHtml: "/poster-html/physics.html", contact: "" },
  ...
  { id: "65", name: "響 日语社 Hibiki", category: "Academic", shortDesc: "Japanese", tags: ["日本文化", "轻量化", "趣味活动", "包容开放"], description: "我们是HIBIKI日语社，主要关注日本文化，是大家于此兴趣的交流平台", image: "/covers/f45.jpg", posters: [], qrcodes: ["/qrcodes/f45-1.png"], posterHtml: "/poster-html/hibiki.html", contact: "" },
  { id: "66", name: "极客工坊 E3 Lab", category: "Academic", shortDesc: "Engineering", tags: ["Engineering", "Empathy", "Empower"], description: "全校唯一一个工程类社团", image: "/covers/b6.jpg", posters: [], qrcodes: ["/qrcodes/f46-1.png"], posterHtml: "/poster-html/e3-lab.html", contact: "" },
  ...
  { id: "70", name: "食品研究社", category: "Academic", shortDesc: "Food Science", tags: ["美食", "实验", "营养", "分享"], description: "从厨房到实验室，探究食物背后的科学与乐趣。", image: "/covers/b12.jpg", posters: ["/posters/f67-1.jpg"], qrcodes: ["/qrcodes/f67-1.png"], posterHtml: "", contact: "" },
  { id: "71", name: "WFLA数学社", category: "Academic", shortDesc: "Math", tags: ["数学", "思维", "竞赛", "钻研"], description: "数学基础和竞赛水平并不是玩转数学的必要条件；只要你对数学保有好奇和热情，WFLA数学社都欢迎你的加入！无论是讨论竞赛技巧与趣味题目，亦或探索高等数学和深层理论，这里都有你的一席之地！", image: "/covers/b5.jpg", posters: ["/posters/b5-1.jpg"], qrcodes: [], posterHtml: "", contact: "" },
  ...
  { id: "74", name: "沪语弄堂", category: "ClubsToBeEstablished", shortDesc: "Shanghainese", tags: ["语言", "文化", "上海", "传承"], description: "本社团聚焦上海语言与文化，旨在向内激发兴趣、深入理解，向外推广沪语文化，为拯救沪语出力。", image: "/covers/b7.jpg", posters: ["/posters/b7-1.jpg"], qrcodes: ["/qrcodes/b7-1.png"], posterHtml: "", contact: "" },
];
